...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-[linear-gradient(110deg,#333_0.6%,#222)] p-4 h-full w-full rounded-xl border border-[#444] dark:border-neutral-600 transition-all duration-300 hover:border-[#666] hover:shadow-lg",
        className,
      )}
    >
...
export const GlowingStarsTitle = ({
  ...
  return <h2 className={cn("font-bold text-xl text-[#eaeaea]", className)}>{children}</h2>
}
